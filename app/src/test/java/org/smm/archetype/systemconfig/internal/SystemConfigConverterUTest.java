...
class SystemConfigConverterUTest extends UnitTestBase {
    ...
    class ToDO {
        ...
        void should_convert_all_fields_when_all_non_null() {
            ...
            config.setDisplayName(org.smm.archetype.systemconfig.internal.DisplayName.of("站点名称"));
    ...
    class RoundTrip {
        ...
        void should_preserve_data_in_round_trip() {
            ...
            original.setDisplayName(org.smm.archetype.systemconfig.internal.DisplayName.of("主题配置"));
