package org.smm.archetype.shared.idempotent;
 ...
 * <p>
 * 注意：不使用 @Component，由 IdempotentConfigure 通过 @Bean 条件注册。
 */
@Slf4j
@Aspect
...
public class IdempotentAspect {
    ...
    private final IdempotentKeyResolver keyResolver = new IdempotentKeyResolver();
