 ...
 * AbstractSearchClient 应为抽象类，公开方法应为 final。
 */
@DisplayName("AbstractSearchClient Template Method 模式")
class AbstractSearchClientUTest {
    ...
    class ClassExistence {
        ...
        @Test
        @DisplayName("AbstractSearchClient 应存在且为抽象类")
        void should_exist_and_be_abstract() {
            Class<?> clazz = AbstractSearchClient.class;
            assertThat(clazz).isNotNull();
            assertThat(Modifier.isAbstract(clazz.getModifiers())).isTrue();
            assertThat(SearchClient.class).isAssignableFrom(clazz);
        }

        @Test
        @DisplayName("SimpleSearchClient 应继承 AbstractSearchClient")
        void simpleSearchClient_should_extend_AbstractSearchClient() {
            Class<?> superclass = SimpleSearchClient.class.getSuperclass();
            assertThat(superclass).isEqualTo(AbstractSearchClient.class);
        }

        @Test
        @DisplayName("SearchClient 接口应包含 15 个方法")
        void searchClient_should_have_15_methods() {
            Method[] methods = SearchClient.class.getDeclaredMethods();
            assertThat(methods.length)
                    .as("SearchClient 接口应包含 15 个方法")
                    .isEqualTo(15);
        }
    }
    ...
    class FinalMethods {
        ...
        void search_should_be_final() throws NoSuchMethodException {
            Method searchMethod = AbstractSearchClient.class.getMethod("search", SearchQuery.class);
        ...
        void index_should_be_final() throws NoSuchMethodException {
            Method indexMethod = AbstractSearchClient.class.getMethod("index", String.class, String.class, Object.class);
        ...
        void delete_should_be_final() throws NoSuchMethodException {
            Method deleteMethod = AbstractSearchClient.class.getMethod("delete", String.class, String.class);
        ...
        void get_should_be_final() throws NoSuchMethodException {
            Method getMethod = AbstractSearchClient.class.getMethod("get", String.class, String.class);
        ...
        void bulkIndex_should_be_final() throws NoSuchMethodException {
            Method bulkIndexMethod = AbstractSearchClient.class.getMethod("bulkIndex", String.class, List.class);
        ...
        void createIndex_should_be_final() throws NoSuchMethodException {
            Method createMethod = AbstractSearchClient.class.getMethod("createIndex", String.class);
        ...
        void deleteIndex_should_be_final() throws NoSuchMethodException {
            Method deleteIndexMethod = AbstractSearchClient.class.getMethod("deleteIndex", String.class);
    ...
    class DoExtensionPoints {
        ...
        void doSearch_should_be_protected_abstract() throws NoSuchMethodException {
            Method doSearchMethod = AbstractSearchClient.class.getDeclaredMethod("doSearch", SearchQuery.class);
        ...
        void doIndex_should_be_protected_abstract() throws NoSuchMethodException {
            Method doIndexMethod = AbstractSearchClient.class.getDeclaredMethod("doIndex", String.class, String.class, Object.class);
        ...
        void doDelete_should_be_protected_abstract() throws NoSuchMethodException {
            Method doDeleteMethod = AbstractSearchClient.class.getDeclaredMethod("doDelete", String.class, String.class);
        ...
        void doGet_should_be_protected_abstract() throws NoSuchMethodException {
            Method doGetMethod = AbstractSearchClient.class.getDeclaredMethod("doGet", String.class, String.class);
        ...
        void doBulkIndex_should_be_protected_abstract() throws NoSuchMethodException {
            Method doBulkIndexMethod = AbstractSearchClient.class.getDeclaredMethod("doBulkIndex", String.class, List.class);
        ...
        void doDeleteIndex_should_be_protected_abstract() throws NoSuchMethodException {
            Method doDeleteIndexMethod = AbstractSearchClient.class.getDeclaredMethod("doDeleteIndex", String.class);
        ...
        void do_methods_should_have_14_extension_points() {
            Set<String> doMethodNames = Arrays.stream(AbstractSearchClient.class.getDeclaredMethods())
