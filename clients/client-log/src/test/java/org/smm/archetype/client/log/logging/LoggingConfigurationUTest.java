...
class LoggingConfigurationUTest {
    ...
    private Environment envWithPath(String path) {
        return new Environment() {
            ...
            @Override public boolean containsProperty(String key) { return "logging.file.path".equals(key); }
            ...
            @Override public boolean acceptsProfiles(org.springframework.core.env.Profiles profiles) { return false; }
        };
    }
